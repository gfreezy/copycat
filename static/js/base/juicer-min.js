(function () {
    ...
    var d = {escapehash: {"<": "&lt;", ">": "&gt;", "&": "&amp;", '"': "&quot;", "'": "&#x27;", "/": "&#x2f;"}, escapereplace: function (e) {
    ...
    c.__cache = {};
    c.version = "0.6.4-stable";
    c.settings = {};
    c.tags = {operationOpen: "{@", operationClose: "}", interpolateOpen: "\\${",interpolateClose:"}", noneencodeOpen: "\\$\\${",noneencodeClose:"}", commentOpen: "\\{#", commentClose: "\\}"};
    c.options = {cache: true, strip: true, errorhandling: true, detection: true, _method: a({__escapehtml: d, __throw: b, __juicer: c}, {})};
    c.tagInit = function () {
        ...
        this.__lexicalAnalyze = function (k) {
            ...
            var h = function (p, i) {
                ...
                if (m(j, i) === -1 && m(g, i) === -1 && m(o, i) === -1) {
                    ...
                    if (typeof(c.options._method[i]) === "function") {
                        o.push(i);
                        return p;
                    }
                    j.push(i);
