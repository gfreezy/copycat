...
(function (b, c) {
    ...
    b.ui = b.ui || {};
    if (!b.ui.version) {
        b.extend(b.ui, {version: "1.8.8", keyCode: {ALT: 18, BACKSPACE: 8, CAPS_LOCK: 20, COMMA: 188, COMMAND: 91, COMMAND_LEFT: 91, COMMAND_RIGHT: 93, CONTROL: 17, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, INSERT: 45, LEFT: 37, MENU: 93, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111, NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106,
...
(function (b) {
    ...
    b.extend(b.ui.draggable, {version: "1.8.8"});
...
(function (b) {
    ...
    b.extend(b.ui.droppable, {version: "1.8.8"});
...
(function (b) {
            ...
            this.selectees.each(function () {
                ...
                if (!(!j || j.element == f.element[0])) {
                    ...
                    if (n) {
                        ...
                        if (j.selected)if (!c.metaKey && !j.startselected) {
                            j.$element.removeClass("ui-selected");
                            j.selected = false;
                            j.$element.addClass("ui-unselecting");
                            j.unselecting = true;
    ...
    b.extend(b.ui.selectable, {version: "1.8.8"})
})(jQuery);
(function (b) {
    b.widget("ui.sortable", b.ui.mouse, {widgetEventPrefix: "sort", options: {appendTo: "parent", axis: false, connectWith: false, containment: false, cursor: "auto", cursorAt: false, dropOnEmpty: true, forcePlaceholderSize: false, forceHelperSize: false, grid: false, handle: false, helper: "original", items: "> *", opacity: false, placeholder: false, revert: false, scroll: true, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect", zIndex: 1E3}, _create: function () {
        ...
        _getDragHorizontalDirection: function () {
            ...
            for (var f =
                null, g = null, e = this.containers.length - 1; e >= 0; e--)if (!b.ui.contains(this.currentItem[0], this.containers[e].element[0]))if (this._intersectsWith(this.containers[e].containerCache)) {
    ...
    b.extend(b.ui.sortable, {version: "1.8.8"})
})(jQuery);
jQuery.effects || function (b, c) {
    ...
    b.extend(b.effects, {version: "1.8.8", save: function (l, k) {
...
(function (b) {
    ...
    b.extend(b.ui.accordion, {version: "1.8.8", animations: {slide: function (c, f) {
        c = b.extend({easing: "swing",
            duration: 300}, c, f);
        ...
        } else c.toHide.animate({height: "hide", paddingTop: "hide", paddingBottom: "hide"}, c); else c.toShow.animate({height: "show",
            paddingTop: "show", paddingBottom: "show"}, c)
...
(function (b, c) {
    ...
    b.extend(b.ui, {datepicker: {version: "1.8.8"}});
...
(function (b, c) {
    ...
    b.extend(b.ui.dialog, {version: "1.8.8", uuid: 0, maxZ: 0, getTitleId: function (e) {
        e = e.attr("id");
        if (!e) {
            this.uuid += 1;
            e = this.uuid
...
(function (b, c) {
    ...
    b.extend(b.ui.progressbar, {version: "1.8.8"})
})(jQuery);
(function (b) {
    ...
    b.extend(b.ui.slider, {version: "1.8.8"})
})(jQuery);
(function (b, c) {
    function f() {
        return++e
        ...
        if (d) {
            ...
            if (j.selected >= 0 && this.anchors.length) {
                ...
                i.element.queue("tabs", function () {
                    i._trigger("show", null, i._ui(i.anchors[j.selected], i.element.find(i._sanitizeSelector(i.anchors[j.selected].hash))))
                });
    ...
    b.extend(b.ui.tabs, {version: "1.8.8"});
