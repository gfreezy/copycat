(function (a) {
    a.scrolltotop = function (k) {
        k = jQuery.extend({startline: 100, scrollto: 0, scrollduration: 500, fadeduration: [500, 100], controlHTML: '<a href="javascript:;"><b>\ufffd\u0635\ufffd\ufffd\ufffd\ufffd\ufffd\ufffd\ufffd</b></a>', className: "", titleName: "\ufffd\u0635\ufffd\ufffd\ufffd\ufffd\ufffd", offsetx: 5, offsety: 5, anchorkeyword: "#top", }, k);
        var c = {isvisible: false, shouldvisible: false};
        var f = this;
        var e, i, d;
        var j = function () {
            var l = document.all;
            ...
            i = a('<div class="' + k.className + '" id="topcontrol">' + k.controlHTML + "</div>").css({position: d ? "fixed" : "absolute", bottom: k.offsety, right: k.offsetx, opacity: 0, cursor: "pointer"}).attr({title: k.titleName}).click(function () {
                b();
                return false;
            }).appendTo("body");
        ...
        var h = function () {
            ...
            if (c.shouldvisible && !c.isvisible) {
                i.stop().animate({opacity: 1}, k.fadeduration[0]);
                c.isvisible = true;
            } else {
                if (c.shouldvisible == false && c.isvisible) {
                    i.stop().animate({opacity: 0}, k.fadeduration[1]);
                    c.isvisible = false;
                }
            }
        };
